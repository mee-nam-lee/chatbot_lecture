...
=======
 ...
 Bot의 메인 화면으로 들어가서, MasterBot을 찾습니다. 메인화면의 검색창에서 찾을 수 있습니다.
...
만약에 MasterBot이 보이지 않다면, 오른쪽 상단의 Import 버튼을 눌러서 MasterBot을 import 해 주세요. import 버튼 클릭후, labfiles\MasterBot_Korean 내부 import.zip일을 import 하면 됩니다.

이제는 챗봇의 다양한 부분을 살펴보고 어떻게 설계되었는지 볼 수
...
이곳에서 "계좌의 잔고가 얼마입니까?" 문장으로 테스트 해보세요. 계좌를 처음부터 봇에게 알려줄 수 도 있습니다.
...
이전에 보신것 처럼, Send money 기능도 테스트 해보세요
